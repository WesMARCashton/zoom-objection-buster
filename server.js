...
app.use(
  bodyParser.json({
    verify: (req, res, buf) => {
      req.rawBody = buf; // keep raw body for HMAC check
    },
  })
);
...
const objectionResponses = {
  ...
  'send a cheque':
    'We always appreciate flexibility in our clients, and I understand you\'re looking for other payment methods." Respond: "To maintain efficiency, quickly secure spots, and for your convenience we streamline our process with credit card payments. It\'s the quickest and easiest way for both of us."',

  // Part 6: Misc Objections
  'not interested':
    'No worries, that makes sense though…I haven’t given you anything to be interested in yet hahaha! "Just for my own notes here, do you mind sharing what makes you say that?"',
  "don't like that vendor":
    'No worries, for my own notes here, do you mind sharing what makes you say that?"',
  'already spoken to someone':
    'My apologies, I don’t mean to bug you! What did you think about the idea?" Or "No worries, in that case…I won’t waste your time going though the same song and dance twice - how much do you already know?"',
  "don't shop there":
    'No worries, I hear you! Out of curiosity, how would you describe your clientele or ideal client? Then proceed to explain how this IS their ideal clientele',
...
app.post('/zoom_webhook_endpoint', (req, res) => {
  ...
  if (req.body?.event === 'endpoint.url_validation') {
    ...
    // HMAC-SHA256(plainToken, ZOOM_SECRET_TOKEN) base64 => encryptedToken
